...
public class FunctionFactory {
	public static Function createFunction(String expression) {
		...
		try {
			return (Function)file_manager.getClassLoader(null).loadClass(name).getConstructor().newInstance();
		...
		throw new RuntimeException("unable to create, load or instanciate class");
	}
}
